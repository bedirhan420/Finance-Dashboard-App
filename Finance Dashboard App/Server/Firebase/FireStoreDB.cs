...
namespace FinanceAPPServer.Firebase
{
    public class FireStoreDB
    {
        ...
        public static async Task UpdateKpiMonthData(string month, string revenue)
        {
            ...
            try
            {
                ...
                List<MonthData> monthDatas = kpi.MonthlyData.Where(m => m.Month == month).ToList();
                ...
                await docRef.UpdateAsync("monthlyData", kpi.MonthlyData);
            }
            catch (Exception e)
            {
                Console.WriteLine($"Error in Update KPI Expense : {e}");
        ...
        public static async Task<AdminDto> GetAdminData()
        {
            ...
            {
                Console.WriteLine($" Error in get admin data {e}");
                return null;
